	...
	<script>
		...
		function ValideName() {
			...
			if (uservalue != null && uservalue != "" && uservalue.length > 3
				...
				xhttp.open("GET", "http://localhost:8002/demo-smita-cm/userName/"+ uservalue);
				xhttp.send();
		...
		function valideEmail() {
			...
			if (userEmailvalue != null && userEmailvalue != ""
				...
				console.log('Running in ajax');
				console.log(userEmailvalue);
				xhttp.open("GET", "http://localhost:8002/demo-smita-cm/email/"
						+ userEmailvalue);
				xhttp.send();
		...
		function ValideMobile() {
			...
			if (userMobilevalue != null && userMobilevalue != ""
				...
				console.log('Running in ajax');
				console.log(userMobilevalue);
				xhttp.open("GET", "http://localhost:8002/demo-smita-cm/mobile/"
						+ userMobilevalue);
				xhttp.send();
